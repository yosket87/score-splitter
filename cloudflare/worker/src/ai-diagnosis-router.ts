...
export async function routeAiDiagnosis(
  ...
  return (
    (await routeContextOrSaved(context)) ??
    (await routeLease(context)) ??
    (await routeSave(context)) ??
    (await routeCategories(context))
  )
}

async function routeContextOrSaved({ request, env, parts }: WorkerRouteContext) {
...
async function routeLease({ request, env, runtime, parts }: WorkerRouteContext) {
...
async function routeSave({ request, env, runtime, parts }: WorkerRouteContext) {
...
async function routeCategories({ request, env, runtime, parts }: WorkerRouteContext) {
