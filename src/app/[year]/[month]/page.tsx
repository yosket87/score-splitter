...
export default async function MonthPage({ params }: MonthPageProps) {
  ...
  const [incomesResult, expensesResult, carryoversResult, summariesResult, paymentStatus, legacyHousehold] = await Promise.all([
      ...
      >
        <aside className="min-w-0 lg:sticky lg:top-20">
          <MonthlyOverview
            ...
            canCheckLegacyPayment={householdId === legacyHousehold.householdId}
